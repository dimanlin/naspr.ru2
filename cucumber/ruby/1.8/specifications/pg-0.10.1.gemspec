...
This library works with PostgreSQL 7.4 and later.}
  ...
  s.files = ["spec/m17n_spec.rb", "spec/pgconn_spec.rb", "spec/pgresult_spec.rb", "spec/lib/helpers.rb", "spec/data/expected_trace.out", "spec/data/random_binary_data", "ext/extconf.rb"]
